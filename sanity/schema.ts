...
import { image, blockContent, seo, hero, tableBlock, faq, alert, commonFields } from './schemas/components'
...
const components = [image, blockContent, seo, hero, tableBlock, faq, alert]
