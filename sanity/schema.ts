...
import { image, blockContent, seo, tableBlock, faq, alert, homeContentBlock, homeContent, homeFaqs, commonFields, homeHero } from './schemas/components'
...
const components = [image, blockContent, seo, tableBlock, faq, alert, homeContentBlock, homeContent, homeFaqs, homeHero]
