...
import { image, blockContent, seo, tableBlock, faq, alert, homeContentBlock, commonFields } from './schemas/components'
...
const components = [image, blockContent, seo, tableBlock, faq, alert, homeContentBlock]
